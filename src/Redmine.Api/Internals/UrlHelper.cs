...
namespace Redmine.Api.Internals
{
    ...
    internal static class UrlHelper
    {
            ...
            where T : class, new()
        {
            ...
            return string.Format(REQUEST_FORMAT, redmineManager.Host, RedmineManager.Suffixes[type], id,
        ...
        public static string GetCreateUrl<T>(RedmineManager redmineManager, string ownerId) where T : class, new()
        {
            ...
            if (type == typeof(Version) || type == typeof(IssueCategory) || type == typeof(ProjectMembership))
            {
                ...
                return string.Format(ENTITY_WITH_PARENT_FORMAT, redmineManager.Host, RedmineKeys.PROJECTS,
                    ownerId, RedmineManager.Suffixes[type], redmineManager.MimeFormat.ToString().ToLower());
            }
            ...
            return string.Format(FORMAT, redmineManager.Host, RedmineManager.Suffixes[type],
                redmineManager.MimeFormat.ToString().ToLower());
        }
            ...
            where T : class, new()
        {
            ...
            if (type == typeof(Version) || type == typeof(IssueCategory) || type == typeof(ProjectMembership))
            {
                ...
                return string.Format(ENTITY_WITH_PARENT_FORMAT, redmineManager.Host, RedmineKeys.PROJECTS,
                    projectId, RedmineManager.Suffixes[type], redmineManager.MimeFormat.ToString().ToLower());
            }
            if (type == typeof(IssueRelation))
            {
                ...
                return string.Format(ENTITY_WITH_PARENT_FORMAT, redmineManager.Host, RedmineKeys.ISSUES,
                    issueId, RedmineManager.Suffixes[type], redmineManager.MimeFormat.ToString().ToLower());
            }
        ...
        {
            return string.Format(REQUEST_FORMAT, redmineManager.Host,
                RedmineManager.Suffixes[typeof(Issue)], issueId + "/watchers",
                redmineManager.MimeFormat.ToString().ToLower());
        }
        ...
        {
            return string.Format(REQUEST_FORMAT, redmineManager.Host,
                RedmineManager.Suffixes[typeof(Issue)], issueId + "/watchers/" + userId,
                redmineManager.MimeFormat.ToString().ToLower());
        }
